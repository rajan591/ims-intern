...
{$sql1="update LMS.record set Date_of_Issue=curdate(),Due_Date=date_add(curdate(),interval 60 day),Renewals_left=1, code='$code' where BookId='$bookid' and RollNo='$rollno'";
 echo $sql1;
...
{$sql2="update LMS.record set Date_of_Issue=curdate(),Due_Date=date_add(curdate(),interval 180 day),Renewals_left=1, code='$code' where BookId='$bookid' and RollNo='$rollno'";
echo $sql2;
